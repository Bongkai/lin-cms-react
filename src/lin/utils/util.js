 ...
 * plain object 的浅比较
 */
Utils.shallowEqual = (obj_1, obj_2) => {
  ...
  const isKeyValueEqual = (arr) => arr.every(item => obj_1[item] === obj_2[item])
  return isKeyValueEqual(key_1) && isKeyValueEqual(key_2)
}

/**
 * dataURL 转 Blob
 */
Utils.dataURLToBlob = (base64) => {
