          ...
          <div className='lin-info-left'>
            <div className='welcome'>
              ...
              <div className='subtitle'>
                ...
                <div className='link'>
                  <a href='http://www.7yue.pro' target='_blank' rel='noopener noreferrer'>http://www.7yue.pro</a>
                </div>
              </div>
            </div>
        ...
        <div className='information'>
          ...
          <div className='article'>
            ...
            <div className='article-list'>
              <div className='article-item' onClick={()=>this.handleArticle('https://opensource.guide/how-to-contribute/')}>
                <img className='article-thumb' src={openSourceImg} alt='' />
                <div className='article-detail'>
                  <p className='article-detail-title'>How to Contribute to Open Source?</p>
                  ...
                  <div className='article-tool'>
                    ...
                    <div className='article-about'>
                      <span><i className='iconfont icon-shoucang'></i>37</span>
                      {/* <el-divider direction='vertical'></el-divider> */}
                      <span><i className='iconfont icon-pinglun'></i>2384</span>
                      {/* <el-divider direction='vertical'></el-divider> */}
                      <span><i className='iconfont icon-fenxiang'></i>56</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className='article-item' onClick={()=>this.handleArticle('https://www.zhihu.com/question/269033309')}>
                <img className='article-thumb' src={openSourceImg} alt='' />
                <div className='article-detail article-last'>
                  <p className='article-detail-title'>为什么程序员们愿意在GitHub上开源自己的成果给别人免费使用和学习？</p>
                  <div className='article-detail-content'>
